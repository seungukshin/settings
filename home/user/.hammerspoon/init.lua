...
remapIME:setAppNames({'Emacs', 'DCV Viewer',
...
remapCtrlCmd:setAppNames({'Emacs', 'DCV Viewer', 'JetBrains Client', 'Code',
			  'WezTerm', 'Alacritty', 'Ghostty', 'kitty',
			  'Firefox'})
...
--hs.hotkey.bind('alt', 'tab', function() hs.hints.windowHints(hs.window.allWindows()) end)
